...
import { makeMemoryGitHubRepository, type MemoryGitHubSeed } from "../repository/github.repository.memory.ts"
...
export const GitHubMemory = (seed: MemoryGitHubSeed = {}) =>
  Layer.effect(GitHubService)(make).pipe(
    Layer.provide(Layer.effect(GitHubRepository)(makeMemoryGitHubRepository(seed))),
  )
