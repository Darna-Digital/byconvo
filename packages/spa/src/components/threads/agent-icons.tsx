/**
 * Brand marks for the agent CLIs, shown in the threads sidebar/header and the
 * "new terminal" menu so each thread reads at a glance as the agent it runs.
...
export function OpencodeIcon({ className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M180 240H60V120H180V240Z" opacity="0.6" />
      <path
        fillRule="evenodd"
